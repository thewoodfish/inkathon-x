...
import { ContractAbi } from '../contract-info/election';
import QueryMethods from '../query/election';
import BuildExtrinsicMethods from '../build-extrinsic/election';
import TxSignAndSendMethods from '../tx-sign-and-send/election';
import MixedMethods from '../mixed-methods/election';
import EventsClass from '../events/election';
